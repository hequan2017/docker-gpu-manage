...
func bizModel() error {
	db := global.GVA_DB
	err := db.AutoMigrate(imageregistry.ImageRegistry{}, computenode.ComputeNode{}, product.ProductSpec{}, instance.Instance{}, pcdn.PcdnNode{}, pcdn.PcdnPolicy{}, pcdn.PcdnDispatchTask{})
	if err != nil {
		return err
	}
	return nil
